...
////////////////////////////////////
// var removeLink = document.getElementsByTagName('a');
var addusr = document.querySelectorAll('ul>li>div>a');
var removeUser = document.getElementById('remove-user');
for (let i = 0; i < addusr.length; i++) {
	const elements =  addusr[i];
	elements.onclick = function(){
		removeUser.style.display = 'flex';
		removeUser.preventDefault();
	}
}
